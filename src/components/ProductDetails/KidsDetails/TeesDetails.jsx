...
const teesDetailsData = [
    ...
    {
        id: 2,
        image: '/src/assets/images/kids/tees2.webp',
        title: 'Product 2',
        price: '₹349',
        originalPrice: '₹999',
        discount: '40% off',
...
const TeesDetails = () => {
    ...
    <div className="products-details">
        ...
        {tees ? (
            <div>
               <img src={tees.image} alt={`tees ${tees.id}`} className="products-image" />
               

                <h2>Fabric: {tees.fabric}</h2>
                <p className='products-avail'>Availability: {tees.availability}</p>
        ...
        {tees && (
            <div>
                ...
                <h4 className='overall-rating'>Overall Rating: {tees.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
