...
const coordinatesDetailsData = [
    ...
    {
        id: 6,
        image: '/src/assets/images/kids/Co-ord6.webp',
        title: 'Product 6',
        price: '₹699',
        originalPrice: '₹999',
        discount: '40% off',
    ...
    {
        id: 7,
        image: '/src/assets/images/kids/Co-ord7.webp',
        title: 'Product 7',
        price: '₹549',
        originalPrice: '₹999',
        discount: '40% off',
    ...
    {
        id: 8,
        image: '/src/assets/images/kids/Co-ord8.webp',
        title: 'Product 8',
        price: '₹649',
        originalPrice: '₹999',
        discount: '40% off',
...
const CoordinatesDetails = () => {
    const { id } = useParams();
    const coordinates = coordinatesDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {coordinates ? (
            <div>
               ...
               <img src={coordinates.image} alt={`coordinates ${coordinates.id}`} className="products-image" />
               

                <h2>Fabric: {coordinates.fabric}</h2>
                <p className='products-avail'>Availability: {coordinates.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{coordinates.shop}</p>
        ...
        {coordinates && (
            <div>
                ...
                <div className="reviews-section">
                    {coordinates.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {coordinates.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {coordinates.similarProducts.map((similar, index) => (
                 <div key={index}>
