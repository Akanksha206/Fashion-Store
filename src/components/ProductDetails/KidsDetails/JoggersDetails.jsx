...
const JoggersDetails = () => {
    const { id } = useParams();
    const joggers = joggersDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {joggers ? (
            <div>
               ...
               <img src={joggers.image} alt={`joggers ${joggers.id}`} className="products-image" />
               

                <h2>Fabric: {joggers.fabric}</h2>
                <p className='products-avail'>Availability: {joggers.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{joggers.shop}</p>
        ...
        {joggers && (
            <div>
                ...
                <div className="reviews-section">
                    {joggers.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {joggers.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {joggers.similarProducts.map((similar, index) => (
                 <div key={index}>
