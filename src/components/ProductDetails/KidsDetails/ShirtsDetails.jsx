...
const ShirtDetails = () => {
    const { id } = useParams();
    const shirts = shirtsDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {shirts ? (
            <div>
               ...
               <img src={shirts.image} alt={`shirts ${shirts.id}`} className="products-image" />
               

                <h2>Fabric: {shirts.fabric}</h2>
                <p className='products-avail'>Availability: {shirts.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{shirts.shop}</p>
        ...
        {shirts && (
            <div>
                ...
                <div className="reviews-section">
                    {shirts.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {shirts.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {shirts.similarProducts.map((similar, index) => (
                 <div key={index}>
