    ...
    <div className="products-details">
        ...
        {product ? (
            <div>
               ...
               <img src={product.image} alt={`Product ${product.id}`} className="products-image" />
               

                <h2>Fabric: {product.fabric}</h2>
                <p className='products-avail'>Availability: {product.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{product.shop}</p>
        ...
        {product && (
            <div>
                ...
                <h4 className='overall-rating'>Overall Rating: {product.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
