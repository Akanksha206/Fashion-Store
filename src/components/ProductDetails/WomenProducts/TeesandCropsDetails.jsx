...
const TeesandCropsDetails = () => {
  const { id } = useParams();
  const Tees = TeesDetailsData.find((p) => p.id === parseInt(id));
  const [pincode, setPincode] = useState("");
  const [deliveryStatus, setDeliveryStatus] = useState("");

  const availablePincodes = ['123456']; 
    ...
    <div className="products-details-container">
      ...
      <div className="products-details">
        ...
        {Tees ? (
          <div>
            ...
            <h2>Fabric: {Tees.fabric}</h2>
            <p className="products-avail">
              Availability: {Tees.availability}
            </p>

            <h4 className="products-shop">Shop Information :</h4>
            <p className="shop-name">{Tees.shop}</p>
            ...
            <div className="products-info">
              {Tees && (
                <div>
                  ...
                  <h4 className="overall-rating">
                    Overall Rating: {Tees.ratings}/5
                  </h4>
                </div>
              )}
            </div>
      ...
      <div className="similar-products-container">
        ...
        <div className="similar-products">
          {Tees.similarProducts.map((similar, index) => (
            <div key={index}>
              <img
                src={similar.image}
                alt={`Similar Products ${index + 1}`}
              ...
              <div className="similar-product-info">
                ...
                <div className="shop">
                  <p>
                    <strong>Shop :</strong> Cotton Hub
                  </p>
                </div>
                <div className="price">
                  <p>
                    <strong>Price : </strong> Rs.259 /-{similar.price}
                  </p>
                </div>
                <div className="Quality">
                  <p>
                    <strong>Quality :</strong> Pure Cotton
                  </p>
                </div>
                <div className="Avail">
                  <p>
