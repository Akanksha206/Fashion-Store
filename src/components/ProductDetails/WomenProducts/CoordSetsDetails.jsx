...
const CoordSetsDetails = () => {
    const { id } = useParams();
    const coordSet = coordSetsDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {coordSet ? (
            <div>
               ...
               <img src={coordSet.image} alt={`Product ${coordSet.id}`} className="products-image" />
               

                <h2>Fabric: {coordSet.fabric}</h2>
                <p className='products-avail'>Availability: {coordSet.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{coordSet.shop}</p>
        ...
        {coordSet && (
            <div>
                ...
                <div className="reviews-section">
                    {coordSet.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {coordSet.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {coordSet.similarProducts.map((similar, index) => (
                 <div key={index}>
