...
const SareesDetails = () => {
    const { id } = useParams();
    const sarees = sareesDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {sarees ? (
            <div>
               ...
               <img src={sarees.image} alt={`sarees ${sarees.id}`} className="products-image" />
               

                <h2>Fabric: {sarees.fabric}</h2>
                <p className='products-avail'>Availability: {sarees.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{sarees.shop}</p>
        ...
        {sarees && (
            <div>
                ...
                <div className="reviews-section">
                    {sarees.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {sarees.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {sarees.similarProducts.map((similar, index) => (
                 <div key={index}>
