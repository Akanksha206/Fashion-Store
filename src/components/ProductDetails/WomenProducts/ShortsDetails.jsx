...
const ShortsDetails = () => {
    const { id } = useParams();
    const shorts  = shortsDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {shorts ? (
            <div>
               ...
               <img src={shorts.image} alt={`Shorts ${shorts.id}`} className="products-image" />
               

                <h2>Fabric: {shorts.fabric}</h2>
                <p className='products-avail'>Availability: {shorts.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{shorts.shop}</p>
        ...
        {shorts && (
            <div>
                ...
                <div className="reviews-section">
                    {shorts .reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {shorts.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {shorts.similarProducts.map((similar, index) => (
                 <div key={index}>
