...
const FloralDetails = () => {
    const { id } = useParams();
    const floral = floralDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {floral ? (
            <div>
               ...
               <img src={floral.image} alt={`floral ${floral.id}`} className="products-image" />
               

                <h2>Fabric: {floral.fabric}</h2>
                <p className='products-avail'>Availability: {floral.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{floral.shop}</p>
        ...
        {floral && (
            <div>
                ...
                <div className="reviews-section">
                    {floral.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {floral.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {floral.similarProducts.map((similar, index) => (
                 <div key={index}>
