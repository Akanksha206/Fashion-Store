...
const SauveDetails = () => {
    const { id } = useParams();
    const sauve = sauveDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {sauve ? (
            <div>
               ...
               <img src={sauve.image} alt={`sauve ${sauve.id}`} className="products-image" />
               

                <h2>Fabric: {sauve.fabric}</h2>
                <p className='products-avail'>Availability: {sauve.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{sauve.shop}</p>
        ...
        {sauve && (
            <div>
                ...
                <div className="reviews-section">
                    {sauve.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {sauve.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {sauve.similarProducts.map((similar, index) => (
                 <div key={index}>
