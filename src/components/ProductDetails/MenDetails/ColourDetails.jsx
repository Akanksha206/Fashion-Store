...
const ColourDetails = () => {
    const { id } = useParams();
    const colour = colourDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {colour ? (
            <div>
               ...
               <img src={colour.image} alt={`colour ${colour.id}`} className="products-image" />
               

                <h2>Fabric: {colour.fabric}</h2>
                <p className='products-avail'>Availability: {colour.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{colour.shop}</p>
        ...
        {colour && (
            <div>
                ...
                <div className="reviews-section">
                    {colour.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {colour.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {colour.similarProducts.map((similar, index) => (
                 <div key={index}>
