...
const ChequeredDetails = () => {
    const { id } = useParams();
    const chequered = chequeredDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {chequered ? (
            <div>
               ...
               <img src={chequered.image} alt={`chequered ${chequered.id}`} className="products-image" />
               

                <h2>Fabric: {chequered.fabric}</h2>
                <p className='products-avail'>Availability: {chequered.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{chequered.shop}</p>
        ...
        {chequered && (
            <div>
                ...
                <div className="reviews-section">
                    {chequered.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {chequered.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {chequered.similarProducts.map((similar, index) => (
                 <div key={index}>
