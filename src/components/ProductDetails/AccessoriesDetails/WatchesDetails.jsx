...
const WatchesDetails = () => {
    const { id } = useParams();
    const watches = watchesDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {watches ? (
            <div>
               ...
               <img src={watches.image} alt={`watches ${watches.id}`} className="products-image" />
               

                <h2>Fabric: {watches.fabric}</h2>
                <p className='products-avail'>Availability: {watches.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{watches.shop}</p>
        ...
        {watches && (
            <div>
                ...
                <div className="reviews-section">
                    {watches.reviews.map((review, index) => (
                ...
                <h4 className='overall-rating'>Overall Rating: {watches.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {watches.similarProducts.map((similar, index) => (
                 <div key={index}>
