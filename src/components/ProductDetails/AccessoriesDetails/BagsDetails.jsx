...
const BagsDetails = () => {
    const { id } = useParams();
    const bags = bagsDetailsData.find(p => p.id === parseInt(id));
    ...
    <div className="products-details">
        ...
        {bags ? (
            <div>
               ...
               <img src={bags.image} alt={`bags ${bags.id}`} className="products-image" />
               

                <h2>Fabric: {bags.fabric}</h2>
                <p className='products-avail'>Availability: {bags.availability}</p>

                <h4 className='products-shop'>Shop Information :</h4>
                <p className='shop-name'>{bags.shop}</p>
        ...
        {bags && (
            <div>
                ...
                <h4 className='overall-rating'>Overall Rating: {bags.ratings}/5</h4>
            </div>
        )}
    </div>
            </div>
    ...
    <div className="similar-products-container">
        ...
        <div className="similar-products">
            {bags.similarProducts.map((similar, index) => (
                 <div key={index}>
